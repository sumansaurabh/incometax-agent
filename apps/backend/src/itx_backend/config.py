...
class Settings(BaseModel):
    ...
    tavily_api_key: str = os.getenv("ITX_TAVILY_API_KEY", os.getenv("TAVILY_API_KEY", ""))
    tavily_base_url: str = os.getenv("ITX_TAVILY_BASE_URL", "https://api.tavily.com")
    tavily_search_depth: str = os.getenv("ITX_TAVILY_SEARCH_DEPTH", "basic")
