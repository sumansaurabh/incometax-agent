...
FIELD_MAPPINGS = {
    ...
    "deductions-vi-a": {
        "deductions.80c.total": {"selector": "#sec80C", "label": "Section 80C"},
        "deductions.80ccd_1b": {"selector": "#sec80CCD1B", "label": "Section 80CCD(1B) - NPS"},
        "deductions.80d.self": {"selector": "#sec80DSelf", "label": "80D - Self & Family"},
        "deductions.80d.parents": {"selector": "#sec80DParents", "label": "80D - Parents"},
    ...
    "tax-paid": {
        "tds.salary": {"selector": "#tdsSalary", "label": "TDS on Salary"},
        "tds.other": {"selector": "#tdsOther", "label": "TDS on Other Income"},
        "advance_tax": {"selector": "#advanceTax", "label": "Advance Tax Paid"},
        "self_assessment_tax": {"selector": "#selfAssessmentTax", "label": "Self Assessment Tax"},
    },
    "capital-gains": {
        "stcg.listed_equity": {"selector": "#stcgEquity", "label": "STCG on Listed Equity"},
        "stcg.other": {"selector": "#stcgOther", "label": "STCG on Other Assets"},
        "ltcg.listed_equity": {"selector": "#ltcgEquity", "label": "LTCG on Listed Equity"},
        "ltcg.other": {"selector": "#ltcgOther", "label": "LTCG on Other Assets"},
    },
    "house-property": {
        "house.rental_income": {"selector": "#rentalIncome", "label": "Annual Rental Income"},
        "house.municipal_tax": {"selector": "#municipalTax", "label": "Municipal Taxes Paid"},
        "house.loan_interest": {"selector": "#homeLoanInterest", "label": "Home Loan Interest"},
    },
}
