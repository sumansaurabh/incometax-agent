...
RUN pip install --no-cache-dir fastapi uvicorn pydantic opentelemetry-sdk opentelemetry-api opentelemetry-exporter-otlp-proto-http asyncpg redis watchfiles websockets
